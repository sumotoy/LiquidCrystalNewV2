...
void LiquidCrystalNew_SHR::begin(byte cols, byte lines, uint8_t dotsize) {
...
void LiquidCrystalNew_SHR::writeGpio(byte value){
	...
	_theData = (value & ~(0x00));
	//_spiobj.writeByte(0x09,_theData);
}
...
void LiquidCrystalNew_SHR::_fastShiftOut(byte val){
}
