...
/* --------------------------------------------------------------------------------
  Following the parameters to initialize LiquidCrystalNew by using a Shift Register
-----------------------------------------------------------------------------------*/
...
#define GPIO_CLK_PIN  5		//clock pin
#define GPIO_DTA_PIN  6		//data pin
#define GPIO_STB_PIN  7		//latch pin
...
LiquidCrystalNew_SHR lcd(GPIO_CLK_PIN,GPIO_DTA_PIN,GPIO_STB_PIN,MULTIPLE_HD_CHIPS);
