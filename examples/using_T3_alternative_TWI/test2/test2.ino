...
/* -----------------------------------------------------------------------------------------------------
  BEWARE: This works only with Teensy3 Hardware!!!!!!!!!!
  Following the parameters to initialize LiquidCrystalNew by proprietary Teensy3 alternative TWI library
  Note: You need to download last version of this library;
  http://forum.pjrc.com/threads/21680-New-I2C-library-for-Teensy3?highlight=wire
---------------------------------------------------------------------------------------------------------*/
// are you using an existing hardware? Remember to include configuration first!
//#include "../LiquidCrystalNew/_configurations/pin_config_ladyada.h"

#define MULTIPLE_HD_CHIPS 1               // 0:normal, 1:2xHD44780     (0 in most cases)
#define T3TWI_PINS         TWI_PINS_18_19 // TWI_PINS_18_19 or TWI_PINS_16_17 
#define T3TWI_PULLUP       TWI_PULLUP_EXT // TWI_PULLUP_EXT or TWI_PULLUP_INT
#define T3TWI_RATE         TWI_RATE_400   // TWI_RATE_100,TWI_RATE_200,TWI_RATE_300,TWI_RATE_400,TWI_RATE_600,TWI_RATE_800,TWI_RATE_1000,TWI_RATE_1200,TWI_RATE_1500,TWI_RATE_2000,TWI_RATE_2400
#define T3TWI_ADRS         0x20           // I2C address
#define GPIO_TYPE          MCP23008       // MCP23008,PCF8574,PCF8574A

#define LCD_COLS 40         //your LCD colums
#define LCD_ROWS 4          //your LCD rows
/*-----------------------------------------------------------
  End of parameters. Following are just sketch parameters
-------------------------------------------------------------*/
...
LiquidCrystalNew_T3TWI lcd(T3TWI_ADRS,T3TWI_PINS,T3TWI_PULLUP,T3TWI_RATE,MULTIPLE_HD_CHIPS,GPIO_TYPE);
