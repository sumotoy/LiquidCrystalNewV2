...
/* ---------------------------------------------------------------
  Following the parameters to initialize LiquidCrystalNew by software SPI
------------------------------------------------------------------*/
...
#define MULTIPLE_HD_CHIPS 0 //0:normal, 1:2xHD44780     (0 in most cases)
#define GPIO_ADRS         0x20     //HAEN address               (0x20 means all address pin to ground)
#define GPIO_CLKPIN       13
#define GPIO_MOSIPIN      11
#define GPIO_CSIPIN       10

#define LCD_COLS 20         //your LCD colums
#define LCD_ROWS 2          //your LCD rows
/*-----------------------------------------------------------
...
LiquidCrystalNew_SSPI lcd(GPIO_MOSIPIN,GPIO_CLKPIN,GPIO_CSIPIN,MULTIPLE_HD_CHIPS,GPIO_ADRS);
