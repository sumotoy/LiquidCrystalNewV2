...
/* ---------------------------------------------------------------
  Following the parameters to initialize LiquidCrystalNew by I2C
------------------------------------------------------------------*/
...
#define GPIO_TYPE MCP23008  //MCP23008,PCF8574,PCF8574A (witch GPIO???)
#define GPIO_ADRS  0x20     //I2C address               (0x20 means all address pin to ground)
...
LiquidCrystalNew_TWI lcd(GPIO_ADRS,MULTIPLE_HD_CHIPS,GPIO_TYPE);
